...
_DATABASEDATA.fields_by_name['data'].message_type = TSPMessages_pb2._DATAREFERENCE
_DATABASEDATAARCHIVE.fields_by_name['data'].message_type = TSPMessages_pb2._REFERENCE
...
class DatabaseDataArchive(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _DATABASEDATAARCHIVE

  # @@protoc_insertion_point(class_scope:TSP.DatabaseDataArchive)

class DatabaseImageDataArchive(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
